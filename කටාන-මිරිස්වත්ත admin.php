...
<head>
    ...
    <title>කටාන-මිරිස්වත්ත මෙතොදිස්ත සභාව - පරිපාලන පැනලය</title>
    <style>
    :root {
...
<body>
 ...
 <button class="dropdown-btn">සාමාජිකයින්</button>
    ...
    <main class="content">
        <div class="header">
            <h1>කටාන-මිරිස්වත්ත  මෙතොදිස්ත සභාව - පරිපාලන පැනලය</h1>
            <p>සභාවේ දත්ත කළමනාකරණය සහ වාර්තාකරණය</p>
        </div>
        
        <div class="form-container">
            <form action="කටාන-මිරිස්වත්ත.php" method="post">
