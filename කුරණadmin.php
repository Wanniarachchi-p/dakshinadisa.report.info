...
<head>
    ...
    <title>කුරණ - මීගමුව මෙතොදිස්ත සභාව - පරිපාලන පැනලය</title>
    <style>
    :root {
...
<body>
    <nav class="sidebar">
        ...
        <div class="dropdown-container">
            ...
            <div class="dropdown-container">
                <a href="#ආධුනිකයන්_ඇතුලු_දේවගැතිවරුන්">ආධුනිකයන් ඇතුලු දේවගැතිවරුන්</a>
    ...
    <main class="content">
        <div class="header">
            <h1>කුරණ - මීගමුව මෙතොදිස්ත සභාව - පරිපාලන පැනලය</h1>
            <p>සභාවේ දත්ත කළමනාකරණය සහ වාර්තාකරණය</p>
        </div>
        
        <div class="form-container">
            <form action="කුරණ.php " method="post">
...
<section id="අනෙකුත්_ගොඩනැගිලි">
    ...
    <label>ගණන:</label>
    <input type="number" name="අනෙකුත් ගොඩනැගිලි_number">
    
    <label>විස්තර:</label>
    <div class="toolbar">
        <button type="button" onclick="format('bold', 'අනෙකුත් ගොඩනැගිලි_description')"><b>B</b></button>
        <button type="button" onclick="format('italic', 'අනෙකුත් ගොඩනැගිලි_description')"><i>I</i></button>
        <button type="button" onclick="format('underline', 'අනෙකුත් ගොඩනැගිලි_description')"><u>U</u></button>
    </div>
    <div class="editor" contenteditable="true" id="අනෙකුත් ගොඩනැගිලි_description"></div>
    <input type="hidden" name="අනෙකුත් ගොඩනැගිලි_description" id="අනෙකුත් ගොඩනැගිලි_description_hidden">
</section>

<!-- මිෂනාරි ආධුනික -->
<section id="ආධුනිකයන්_ඇතුලු_දේවගැතිවරුන්">
    <h2>මිෂනාරි ආධුනික</h2>
    <label>ගණන:</label>
    <input type="number" name="ආධුනිකයන් ඇතුලු දේවගැතිවරුන්_number">
    
    <label>විස්තර:</label>
    <div class="toolbar">
        <button type="button" onclick="format('bold', 'ආධුනිකයන් ඇතුලු දේවගැතිවරුන්_description')"><b>B</b></button>
        <button type="button" onclick="format('italic', 'ආධුනිකයන් ඇතුලු දේවගැතිවරුන්_description')"><i>I</i></button>
        <button type="button" onclick="format('underline', 'ආධුනිකයන් ඇතුලු දේවගැතිවරුන්_description')"><u>U</u></button>
    </div>
    <div class="editor" contenteditable="true" id="ආධුනිකයන් ඇතුලු දේවගැතිවරුන්_description"></div>
    <input type="hidden" name="ආධුනිකයන් ඇතුලු දේවගැතිවරුන්_description" id="ආධුනිකයන් ඇතුලු දේවගැතිවරුන්_description_hidden">
</section>
...
<!-- අවුරුදු 5-15 දක්වා -->
<section id="අවුරුදු _5-15 _දක්වා">
